...
![Electric organ dissection landmarks: incisions just anterior to the caudal peduncle, skin pulled laterally to expose the organ, and the spinal column cut anterior and posterior to free the columns for transfer.](files/dissection/eo_dissection.png){fig-alt="Diagram of a mormyrid fish from a lateral and dorsal view, showing the location of incisions used to access the electric organ in the caudal peduncle."}
...
![Opercular skin dissection landmarks: contour traced along the opercular margin, scalpel slid parallel to the fish surface to free skin from underlying fascia and muscle, lifted away as a single uniform piece.](files/dissection/skin_dissection.png){fig-alt="Diagram of a mormyrid fish head, with a dashed contour traced around the operculum showing the area of skin to be removed for snRNA-seq sampling."}
...
![Brain dissection landmarks: slit cut at the back of the cranium, scissors followed forward along the spinal cord through the skull case to the nose, skull pulled apart with forceps to expose the brain, valvula cerebelli lifted away to reveal the underlying brain regions.](files/dissection/brain_dissection.png){fig-alt="Diagram of a mormyrid fish head from above, showing the skull cuts used to access the brain and the anatomy of the brain after the valvula cerebelli is lifted away."}
