...
<video id="lecture-99" playsinline controls preload="metadata">
  <source src="https://d18e7eu8nurr5a.cloudfront.net/lectures/introduction.mp4"
          type="video/mp4" />
  Your browser does not support embedded video.
</video>
<script src="https://cdnjs.cloudflare.com/ajax/libs/plyr/3.8.3/plyr.polyfilled.min.js"></script>
<script>
  new Plyr('#Introduction', {
    settings: ['speed'],
