...
![Same field after the 1.8 M sucrose cushion. The grid is now sparse and clean — most of the small debris is gone, with only a few well-separated particles visible. Nuclei recovery is lower but the suspension is dramatically cleaner.](files/nuclei_isolation/hindbrain_post_sucrose.20x.png)
