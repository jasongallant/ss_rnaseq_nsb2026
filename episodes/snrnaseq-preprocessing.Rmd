...
```{r elbow-plot, message=FALSE, warning=FALSE, fig.alt="Elbow plot showing variance explained by each principal component.", fig.cap="Elbow plot for the EO dataset. The curve flattens around PC 15–20; using 20 PCs comfortably covers the informative range."}
...
- We use **20 PCs** throughout this episode.
...
::: {.callout-important title="Challenge 3: Are any clusters sample-dominated? (10 min)"}
